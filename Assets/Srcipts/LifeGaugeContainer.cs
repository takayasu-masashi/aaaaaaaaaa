...
public class LifeGaugeContainer : MonoBehaviour
{
    ...
    private readonly Dictionary<MobStatus, LifeGauge> _statusLifeBarMap = new Dictionary<MobStatus, LifeGauge>();   //アクティブなライフゲージを保持するライフゲージを保持するコンテナ
    ...
    //ライフゲージを破棄します
    /// <param name="status"></param>
    public void Removed(MobStatus status)
    {
